...
{{-- Estilos específicos para esta vista, se añade versión para evitar cache --}}
...
<div class="container">
    ...
    <!-- ========================================
             Sección del encabezado con título y botones
             ======================================== -->
    <div class="header-section">
        ...
        <div class="header-buttons">
            ...
            <!-- Botón para generar Excel global -->
            <a href="{{ route('excel.equipos.global', request()->query()) }}"
                class="btn-header-pdf"
                style="background-color: #107c41; margin-left: 10px;"
                target="_blank">
    ...
    <div class="simple-search-container">
        <form action="{{ route('equipos.index') }}" method="GET" class="simple-search-form">
            <div class="search-wrapper">
                ...
                <!-- Botón de limpiar búsqueda si hay resultados filtrados -->
                @if(request('search'))
    ...
    <div class="table-container">
        <table class="equipos-table">
            ...
            <tbody>
                ...
                <tr>
                    <!-- Mostrar información del equipo, con valores por defecto si están vacíos -->
                    ...
                    <td>
                        <div class="action-toggle-container text-center">
                            <!-- Botón para desplegar menú de acciones -->
                            <button class="btn btn-sm toggle-actions-btn"
                                onclick="toggleActions('actions-{{ $e->id_equipo }}')"
                                title="Ver Acciones"
                                style="color: #dc2626; background: none; border: none; padding: 0.25rem;">
                                <i class="fas fa-ellipsis-v"></i>
                            </button>

                            <!-- Menú de acciones oculto inicialmente -->
...
<script>
    /**
     * Mostrar/ocultar menú de acciones del equipo
     * @param {string} id - ID del contenedor de acciones
     */
